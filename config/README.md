...
- These are the minimum required vars need to setup to make Fubuki Music Bot Work.
...
- You can play tracks or playlists from spotify from Fubuki Music bot
...
- If you plan to use Fubuki Music Bot with your own customized or modified code.
...
- You can change images which are used in Fubuki Music Bot.
- You can generate telegaph links from [@Gabi_Braun_Robot](http://t.me/Gabi_Braun_Robot) by doing /tgm and use it here.
...
1. `STRING_SESSION2` : Pyrogram Session Needed, Generate string from [Replit](https://replit.com/@CoolGuyKisaki/Generate-Telegram-String-Session#main.py) in Replit.
2. `STRING_SESSION3` : Pyrogram Session Needed, Generate string from [Replit](https://replit.com/@CoolGuyKisaki/Generate-Telegram-String-Session#main.py) in Replit.
3. `STRING_SESSION4` : Pyrogram Session Needed, Generate string from [Replit](https://replit.com/@CoolGuyKisaki/Generate-Telegram-String-Session#main.py) in Replit.
4. `STRING_SESSION5` : Pyrogram Session Needed, Generate string from [Replit](https://replit.com/@CoolGuyKisaki/Generate-Telegram-String-Session#main.py) in Replit.
